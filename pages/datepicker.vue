  ...
  <div>
    ...
    >
        ...
        <div class="el-picker-panel__body">
          <div class="el-date-picker__time-header">
            <span class="el-date-picker__editor-wrap">
              <input
                :placeholder="'el.datepicker.selectDate'"
                :value="visibleDate"
            ...
            <span class="el-date-picker__editor-wrap">
              <input
                ...
                :placeholder="'el.datepicker.selectTime'"
                :value="visibleTime"
          ...
          >
            <button
              type="button"
              @click="prevYear"
              :aria-label="`el.datepicker.prevYear`"
            ...
            <button
              ...
              :aria-label="`el.datepicker.prevMonth`"
            ...
            >{{`el.datepicker.month${ month + 1 }`}}</span>
            <button
              type="button"
              @click="nextYear"
              :aria-label="`el.datepicker.nextYear`"
            ...
            <button
              ...
              @click="nextMonth"
              v-show="currentView === 'date'"
              :aria-label="`el.datepicker.nextMonth`"
      ...
      <div class="el-picker-panel__footer" v-show="footerVisible && currentView === 'date'">
        ...
        >{{ 'el.datepicker.now' }}</button>

        <button
          plain
          class="el-picker-panel__link-btn"
          @click="confirm"
        >{{ 'el.datepicker.confirm' }}</button>
      </div>
    </div>
  </div>
</template>
...
import ElDatePicker from "~/vendor/el-date-picker";
