<template>
  <div>
    <Listview :value="json[0]" :multiSelect="true" :displayId="true" @settingChange="test" />
    <!-- <quick-input
...
import quickInput from "~/components/parts/quickInput.vue";
    ...
    this.json.push({
      query: [
        ...
        },
        {
          ...
          orderindex: 1,
          control: "datebox",
          defalutvalue: ["2015-01-01", "2016-01-01"]
        },
        {
          id: "Qty",
          name: "件数",
