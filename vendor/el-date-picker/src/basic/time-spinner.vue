...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from '~/vendor/el-common/utils/date-util';
  import ElScrollbar from '~/vendor/el-scrollbar/';
  import RepeatClick from '~/vendor/el-common/directives/repeat-click';
